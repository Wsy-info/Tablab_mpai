...
row_annots$Pathway <- factor(row_annots$Pathway, levels = c(c("Heart morphogenesis", "RNA splicing", "Metabolic process", "up_Signaling related", "Immune related", "Cardiac function", "down_Signaling related")))
pathway_colors <- c("Heart morphogenesis" = "#b5aa82",
                   "RNA splicing" = "#FFB764",
                    "Metabolic process" = "#33A02C",
                   "up_Signaling related" = "#FF7F00",
                   "Immune related" = "#CAB2D6",
                   "Cardiac function" = "#9acd32",
...
pdf("Heart_DEGs_heatmap.pdf", height = 20, width = 10)
p1
p2
dev.off()