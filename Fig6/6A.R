...
row_annots$Pathway <- factor(row_annots$Pathway, levels = c("Energy derivation", "up_Metabolic process", "Translation", "Up_Transport", "up_Signaling related", "Immune related", "down_Metabolic process"))
pathway_colors <- c("Energy derivation" = "#B15928",
                    "up_Metabolic process" = "#33A02C",
                    "Translation" = "#1F78B4",
                    "Up_Transport" = "#FDBF6F",
                    "up_Signaling related" = "#FF7F00",
                    "Immune related" = "#CAB2D6",
                    "down_Metabolic process" = "#FF7F00")
...
pdf("Kidney_DEGs_heatmap_new.pdf", height = 20, width = 10)
p1 + p2
dev.off()