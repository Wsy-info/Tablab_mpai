...
adata = anndata.read_h5ad('kidney_O_Y_aging.h5ad')
### prepare label
...
### dataset for predict
adata_drug = anndata.read_h5ad('kidney_aging.h5ad')
...
results_df.to_csv('prediction_kidney_aging_bys.csv', index = False)