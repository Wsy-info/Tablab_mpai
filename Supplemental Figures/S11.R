...
old_young <- get_degs(kidney.harmony, "Young")
met_old <- get_degs(kidney.harmony, "MET")
nr_old <- get_degs(kidney.harmony, "NR")
dq_old <- get_degs(kidney.harmony, "D+Q")
spd_old <- get_degs(kidney.harmony, "SPD")

### prepare data for barplot
### Old vs. Young
cell <-  paste(rep(levels(kidney.harmony), each = 2), rep(c("Old", "Young"), times = 2), sep = "_")
...
### MET vs. Old
cell <-  paste(rep(levels(kidney.harmony), each = 2), rep(c("MET", "Old"), times = 2), sep = "_")
...
### NR
cell <-  paste(rep(levels(kidney.harmony), each = 2), rep(c("NR", "Old"), times = 2), sep = "_")
...
### D+Q
cell <-  paste(rep(levels(kidney.harmony), each = 2), rep(c("D+Q", "Old"), times = 2), sep = "_")
...
### SPD
cell <-  paste(rep(levels(kidney.harmony), each = 2), rep(c("SPD", "Old"), times = 2), sep = "_")
...
pdf("Kidney_solo_DEGs.pdf", width = 18)
