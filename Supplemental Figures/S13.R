...
old_young <- get_degs(liver.harmony, "Young")
met_old <- get_degs(liver.harmony, "MET")
nr_old <- get_degs(liver.harmony, "NR")
dq_old <- get_degs(liver.harmony, "D+Q")
spd_old <- get_degs(liver.harmony, "SPD")

### prepare data for barplot
### Old vs. Young
cell <-  paste(rep(levels(liver.harmony), each = 2), rep(c("Old", "Young"), times = 2), sep = "_")
...
### MET vs. Old
cell <-  paste(rep(levels(liver.harmony), each = 2), rep(c("MET", "Old"), times = 2), sep = "_")
...
### NR
cell <-  paste(rep(levels(liver.harmony), each = 2), rep(c("NR", "Old"), times = 2), sep = "_")
...
### D+Q
cell <-  paste(rep(levels(liver.harmony), each = 2), rep(c("D+Q", "Old"), times = 2), sep = "_")
...
### SPD
cell <-  paste(rep(levels(liver.harmony), each = 2), rep(c("SPD", "Old"), times = 2), sep = "_")
...
pdf("Liver_solo_DEGs.pdf", width = 18)
